 ...
 */
function randFromTo(t,e){return Math.floor(Math.random()*(e-t+1))+t}function isCollide(t,e,i){var i=i?i:0,o=t.offset().top,n=t.offset().left,s=e.offset().top,a=e.offset().left;return!(o+t.height()+i<s||o-i>s+e.height()||n+t.width()+i<a||n-i>a+e.width())}if("undefined"==typeof jQuery)throw new Error("Bootstrap requires jQuery");/* ========================================================================
